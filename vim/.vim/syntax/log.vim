...
syn match logDate '\d\{2,4}[-\/]\(\d\{2}\|Jan\|Feb\|Mar\|Apr\|May\|Jun\|Jul\|Aug\|Sep\|Oct\|Nov\|Dec\|PASSED\|PASS\)[-\/]\d\{2,4}T\?'
...
syn keyword logDate Mon Tue Wed Thu Fri Sat Sun Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec PASSED PASS nextgroup=logDateDay
...
syn keyword logLevelCritical CRITICAL CRIT FATAL UVM_FATAL fatal
syn keyword logLevelError ERROR ERR FAILURE SEVERE UVM_ERROR error FAILED
syn keyword logLevelWarning WARNING WARN UVM_WARNING warning
