...
syn keyword	svStatement	join_any join_none forkjoin binsof intersect wait wait_order
...
syn keyword 	svModifier	ref const pure automatic context
...
syn keyword verilogStatement shortreal chandle string
syn keyword verilogStatement bins illegal_bins ignore_bins
syn keyword verilogStatement matches
syn keyword verilogStatement assume expect
syn keyword verilogStatement null tagged
syn keyword verilogStatement first_match throughout timeprecision
syn keyword verilogStatement timeunit type union
syn keyword verilogStatement uwire cross
syn keyword verilogStatement within
...
"-------------------------------------------------------------------------------
" uvm_phase
syn keyword uvmMethod build_phase connect_phase end_of_elaboration_phase start_of_simulation_phase
syn keyword uvmMethod extract_phase check_phase report_phase final_phase
syn keyword uvmMethod run_phase
syn keyword uvmMethod pre_reset_phase reset_phase post_reset_phase
syn keyword uvmMethod pre_configure_phase configure_phase post_configure_phase
syn keyword uvmMethod pre_main_phase main_phase post_main_phase
syn keyword uvmMethod pre_shutdown_phase shutdown_phase post_shutdown_phase
